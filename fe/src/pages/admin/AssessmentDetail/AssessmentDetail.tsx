...
const AssessmentDetail = () => {
  ...
  // Handle review student attempt
  const handleReviewAttempt = (assessmentId: string, userId: string) => {
    navigate(`/admin/assessments/${assessmentId}/users/${userId}/review`);
  };
        ...
        <Row>
          ...
          <Col md={9}>
                          ...
                          <Accordion.Body>
                            ...
                            <div className="d-flex justify-content-end">
                              <Button
                                ...
                                onClick={() =>
                                  navigate(
                                    `/admin/assessments/${id}/questions/${question.id}/edit`
                                  )
                                }
                              >
                ...
                <Card.Body>
                  <Tabs defaultActiveKey="studentView" className="mb-3">
                    <Tab eventKey="studentView" title="Student View">
                      <div className="preview-container">
                        ...
                        {questions.length === 0 ? (
                          <div className="text-center py-4">
                            <p>
                              No questions to preview. Add questions to see how
                              the assessment will appear to students.
                            </p>
                          </div>
                        ) : (
                    ...
                    <Tab eventKey="resultsView" title="Results View">
                      <div className="preview-container">
                        <Alert variant="info">
                          This is a preview of how results will appear to
                          students if "Show results after completion" is
                          enabled.
                        </Alert>
                        ...
                        <div className="results-preview">
                          ...
                          <div className="feedback-section">
                            <h5>Feedback</h5>
                            <p>
                              Good work! You've demonstrated a solid
                              understanding of the core concepts. Continue to
                              practice with more advanced examples to strengthen
                              your skills.
                            </p>
                          </div>
                        </div>
            ...
            {activeTab === "student-submissions" && (
              <Card>
                <Card.Header>
                  This is the student list tab. You can add functionality here
                  to show students who have taken this assessment.
                </Card.Header>
                <Card.Body>
                      ...
                      <tbody>
                        {studentSubmissions.map((student) => (
                          <tr
                            ...
                            onClick={() => {
                              handleReviewAttempt(assessment.id, student.id);
                            }}
                          >
                            <td>{student.id}</td>
                            <td>{student.name}</td>
              ...
              <Card>
                ...
                <Card.Body>
                  <Accordion defaultActiveKey="0">
                    <Accordion.Item eventKey="0">
                      ...
                      <Accordion.Body>
                        <ul className="help-list">
                          <li>
                            Use clear, concise language that students will
                            understand
                          </li>
                          <li>
                            Make sure each question tests a specific learning
                            objective
                          </li>
                          <li>
                          ...
                          <li>
                            Avoid negatively worded questions (e.g., "Which is
                            NOT...")
                          </li>
                          <li>
                            Ensure only one answer is correct for objective
                            questions
                          </li>
                          <li>
                            For essay questions, clearly state what you're
                            looking for
                          </li>
                        </ul>
                      </Accordion.Body>
                    ...
                    <Accordion.Item eventKey="1">
                      ...
                      <Accordion.Body>
                        <ul className="help-list">
                          <li>
                            <strong>Randomize Questions:</strong> Shuffles
                            questions to reduce cheating
                          </li>
                          <li>
                            <strong>Show Results:</strong> Determines if
                            students see their scores and feedback immediately
                          </li>
                          <li>
                            <strong>Retakes:</strong> Allow students to attempt
                            the assessment multiple times
                          </li>
                          <li>
                            <strong>Time Limit:</strong> Set a maximum duration
                            for completing the assessment
                          </li>
                          <li>
                            <strong>Proctoring:</strong> Enable webcam
                            monitoring and other anti-cheating measures
                          </li>
                        </ul>
                      </Accordion.Body>
                    </Accordion.Item>
                    <Accordion.Item eventKey="2">
                      ...
                      <Accordion.Body>
                        <p>
                          After students complete your assessment, you'll be
                          able to view detailed analytics including:
                        </p>
                        <ul className="help-list">
                        ...
                        <p>
                          These insights can help you improve your assessments
                  ...
                  <Alert variant="info" className="mt-4">
                    ...
                    <p className="mb-0">
                      Visit our <a href="#">documentation center</a> for
                      detailed guides or contact{" "}
                      <a href="mailto:tuanne@gmail.com">tuanne@gmail.com</a> for
                      assistance.
                    </p>
                  </Alert>
                </Card.Body>
